...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 60 76 10 80 	movl   $0x80107660,(%esp)
...
80100bab:	e8 90 5f 00 00       	call   80106b40 <clearpteu>
...
80100c19:	e8 62 61 00 00       	call   80106d80 <copyout>
...
80100c86:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c8c:	e8 ef 60 00 00       	call   80106d80 <copyout>
...
80100cea:	8b 77 04             	mov    0x4(%edi),%esi
  sz = PGROUNDUP(sz);
80100ced:	05 ff 0f 00 00       	add    $0xfff,%eax
80100cf2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80100cf7:	89 07                	mov    %eax,(%edi)
  curproc->tf->eip = elf.entry;  // main
80100cf9:	8b 47 18             	mov    0x18(%edi),%eax
  curproc->pgdir = pgdir;
80100cfc:	89 57 04             	mov    %edx,0x4(%edi)
  curproc->tf->eip = elf.entry;  // main
80100cff:	8b 95 3c ff ff ff    	mov    -0xc4(%ebp),%edx
80100d05:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100d08:	8b 47 18             	mov    0x18(%edi),%eax
80100d0b:	89 58 44             	mov    %ebx,0x44(%eax)
  curproc->stackNum = 1; // initialize stacknum
80100d0e:	c7 47 7c 01 00 00 00 	movl   $0x1,0x7c(%edi)
  switchuvm(curproc);
80100d15:	89 3c 24             	mov    %edi,(%esp)
80100d18:	e8 53 59 00 00       	call   80106670 <switchuvm>
  freevm(oldpgdir);
80100d1d:	89 34 24             	mov    %esi,(%esp)
80100d20:	e8 eb 5c 00 00       	call   80106a10 <freevm>
  return 0;
...
80101eec:	e8 6f e4 ff ff       	call   80100360 <panic>
    panic("dirlink");
80101ef1:	c7 04 24 06 76 10 80 	movl   $0x80107606,(%esp)
...
80102e13:	e8 08 3d 00 00       	call   80106b20 <kvmalloc>
...
801036e3:	e8 a8 33 00 00       	call   80106a90 <setupkvm>
...
8010383a:	e8 b1 31 00 00       	call   801069f0 <deallocuvm>
...
8010387e:	e8 ed 32 00 00       	call   80106b70 <copyuvm>
...
80103d38:	e8 d3 2c 00 00       	call   80106a10 <freevm>
        release(&ptable.lock);
...
80103e84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e88:	c7 04 24 60 76 10 80 	movl   $0x80107660,(%esp)
...
8010463d:	8b 14 85 80 75 10 80 	mov    -0x7fef8a80(,%eax,4),%edx
...
80104666:	c7 04 24 51 75 10 80 	movl   $0x80107551,(%esp)
...
801047f0:	c7 44 24 04 fc 75 10 	movl   $0x801075fc,0x4(%esp)
801047f7:	80 
...
8010480b:	c7 44 24 04 fb 75 10 	movl   $0x801075fb,0x4(%esp)
80104812:	80 
...
80104821:	79 89                	jns    801047ac <create+0xdc>
      panic("create dots");
80104823:	c7 04 24 ef 75 10 80 	movl   $0x801075ef,(%esp)
8010482a:	e8 31 bb ff ff       	call   80100360 <panic>
    panic("create: dirlink");
8010482f:	c7 04 24 fe 75 10 80 	movl   $0x801075fe,(%esp)
80104836:	e8 25 bb ff ff       	call   80100360 <panic>
    panic("create: ialloc");
8010483b:	c7 04 24 e0 75 10 80 	movl   $0x801075e0,(%esp)
...
80104be1:	c7 44 24 04 fc 75 10 	movl   $0x801075fc,0x4(%esp)
80104be8:	80 
...
80104bf9:	c7 44 24 04 fb 75 10 	movl   $0x801075fb,0x4(%esp)
80104c00:	80 
...
80104d4d:	c7 04 24 20 76 10 80 	movl   $0x80107620,(%esp)
80104d54:	e8 07 b6 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104d59:	c7 04 24 32 76 10 80 	movl   $0x80107632,(%esp)
80104d60:	e8 fb b5 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104d65:	c7 04 24 0e 76 10 80 	movl   $0x8010760e,(%esp)
...
80105219:	e8 52 1c 00 00       	call   80106e70 <shm_open>
}
8010521e:	c9                   	leave  
8010521f:	c3                   	ret    
    return -1;
...
80105253:	e8 28 1c 00 00       	call   80106e80 <shm_close>
}
80105258:	c9                   	leave  
80105259:	c3                   	ret    
...
80105499:	c7 44 24 04 41 76 10 	movl   $0x80107641,0x4(%esp)
801054a0:	80 
...
80105530:	ff 24 85 44 77 10 80 	jmp    *-0x7fef88bc(,%eax,4)
80105537:	90                   	nop
      break;
...
8010553f:	90                   	nop
80105540:	0f 84 a6 02 00 00    	je     801057ec <trap+0x2dc>
80105546:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010554a:	0f 84 9c 02 00 00    	je     801057ec <trap+0x2dc>
...
801055a3:	c7 04 24 00 77 10 80 	movl   $0x80107700,(%esp)
...
80105650:	0f 20 d0             	mov    %cr2,%eax
      if (KERNBASE > rcr2()) { //rcr2 address causing pagefault, checking if from userspace
80105653:	85 c0                	test   %eax,%eax
80105655:	0f 88 65 01 00 00    	js     801057c0 <trap+0x2b0>
8010565b:	0f 20 d0             	mov    %cr2,%eax
        if (tf->esp >= rcr2()) {
8010565e:	39 43 44             	cmp    %eax,0x44(%ebx)
80105661:	0f 82 59 ff ff ff    	jb     801055c0 <trap+0xb0>
            uint topOfStack = KERNBASE - myproc()->stackNum * PGSIZE; // right above page guard, where to start allocating
80105667:	e8 34 e0 ff ff       	call   801036a0 <myproc>
8010566c:	8b 40 7c             	mov    0x7c(%eax),%eax
8010566f:	f7 d8                	neg    %eax
80105671:	c1 e0 0c             	shl    $0xc,%eax
            if (allocuvm(myproc()->pgdir, PGROUNDDOWN(topOfStack - 1), topOfStack - 1) == 0) { // check if we can allocate
80105674:	8d b0 ff ff ff 7f    	lea    0x7fffffff(%eax),%esi
8010567a:	e8 21 e0 ff ff       	call   801036a0 <myproc>
8010567f:	89 74 24 08          	mov    %esi,0x8(%esp)
80105683:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80105689:	89 74 24 04          	mov    %esi,0x4(%esp)
8010568d:	8b 40 04             	mov    0x4(%eax),%eax
80105690:	89 04 24             	mov    %eax,(%esp)
80105693:	e8 38 12 00 00       	call   801068d0 <allocuvm>
80105698:	85 c0                	test   %eax,%eax
8010569a:	0f 84 36 01 00 00    	je     801057d6 <trap+0x2c6>
            myproc()->stackNum++;
801056a0:	e8 fb df ff ff       	call   801036a0 <myproc>
801056a5:	83 40 7c 01          	addl   $0x1,0x7c(%eax)
            cprintf("%d pages currently allocated. \n", myproc()->stackNum);
801056a9:	e8 f2 df ff ff       	call   801036a0 <myproc>
801056ae:	8b 40 7c             	mov    0x7c(%eax),%eax
801056b1:	c7 04 24 ac 76 10 80 	movl   $0x801076ac,(%esp)
801056b8:	89 44 24 04          	mov    %eax,0x4(%esp)
801056bc:	e8 8f af ff ff       	call   80100650 <cprintf>
801056c1:	e9 fa fe ff ff       	jmp    801055c0 <trap+0xb0>
...
801057c0:	c7 04 24 46 76 10 80 	movl   $0x80107646,(%esp)
801057c7:	e8 84 ae ff ff       	call   80100650 <cprintf>
          exit();
801057cc:	e8 cf e2 ff ff       	call   80103aa0 <exit>
801057d1:	e9 ea fd ff ff       	jmp    801055c0 <trap+0xb0>
                cprintf("No new page can be allocated. \n");
801057d6:	c7 04 24 8c 76 10 80 	movl   $0x8010768c,(%esp)
801057dd:	e8 6e ae ff ff       	call   80100650 <cprintf>
                exit();
801057e2:	e8 b9 e2 ff ff       	call   80103aa0 <exit>
801057e7:	e9 b4 fe ff ff       	jmp    801056a0 <trap+0x190>
801057ec:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801057ef:	8b 73 38             	mov    0x38(%ebx),%esi
801057f2:	e8 89 de ff ff       	call   80103680 <cpuid>
801057f7:	89 7c 24 10          	mov    %edi,0x10(%esp)
801057fb:	89 74 24 0c          	mov    %esi,0xc(%esp)
801057ff:	89 44 24 08          	mov    %eax,0x8(%esp)
80105803:	8b 43 30             	mov    0x30(%ebx),%eax
80105806:	c7 04 24 cc 76 10 80 	movl   $0x801076cc,(%esp)
8010580d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105811:	e8 3a ae ff ff       	call   80100650 <cprintf>
      panic("trap");
80105816:	c7 04 24 62 76 10 80 	movl   $0x80107662,(%esp)
8010581d:	e8 3e ab ff ff       	call   80100360 <panic>
80105822:	66 90                	xchg   %ax,%ax
...
80105917:	00 
  for(p="xv6...\n"; *p; p++)
80105918:	bb 0c 78 10 80       	mov    $0x8010780c,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80106641:	c3                   	ret    
      panic("remap");
80106642:	c7 04 24 14 78 10 80 	movl   $0x80107814,(%esp)
...
80106751:	c7 04 24 1a 78 10 80 	movl   $0x8010781a,(%esp)
80106758:	e8 03 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
8010675d:	c7 04 24 45 78 10 80 	movl   $0x80107845,(%esp)
80106764:	e8 f7 9b ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106769:	c7 04 24 30 78 10 80 	movl   $0x80107830,(%esp)
...
801067fe:	c7 04 24 59 78 10 80 	movl   $0x80107859,(%esp)
...
801068b2:	c7 04 24 73 78 10 80 	movl   $0x80107873,(%esp)
801068b9:	e8 a2 9a ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
801068be:	c7 04 24 14 79 10 80 	movl   $0x80107914,(%esp)
...
801068d9:	8b 7d 10             	mov    0x10(%ebp),%edi
  if(newsz > KERNBASE)
801068dc:	81 ff 00 00 00 80    	cmp    $0x80000000,%edi
801068e2:	0f 87 98 00 00 00    	ja     80106980 <allocuvm+0xb0>
  if(newsz < oldsz)
801068e8:	3b 7d 0c             	cmp    0xc(%ebp),%edi
    return oldsz;
801068eb:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
801068ee:	0f 82 8e 00 00 00    	jb     80106982 <allocuvm+0xb2>
  a = PGROUNDUP(oldsz);
801068f4:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
801068fa:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80106900:	39 df                	cmp    %ebx,%edi
80106902:	77 5b                	ja     8010695f <allocuvm+0x8f>
80106904:	e9 87 00 00 00       	jmp    80106990 <allocuvm+0xc0>
...
80106923:	e8 58 d9 ff ff       	call   80104280 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106928:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
8010692e:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106932:	8b 45 08             	mov    0x8(%ebp),%eax
80106935:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
8010693c:	00 
8010693d:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106944:	00 
80106945:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106949:	89 04 24             	mov    %eax,(%esp)
8010694c:	e8 7f fc ff ff       	call   801065d0 <mappages>
80106951:	85 c0                	test   %eax,%eax
80106953:	78 4b                	js     801069a0 <allocuvm+0xd0>
  for(; a < newsz; a += PGSIZE){
80106955:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010695b:	39 df                	cmp    %ebx,%edi
8010695d:	76 31                	jbe    80106990 <allocuvm+0xc0>
    mem = kalloc();
8010695f:	e8 3c bb ff ff       	call   801024a0 <kalloc>
    if(mem == 0){
80106964:	85 c0                	test   %eax,%eax
    mem = kalloc();
80106966:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106968:	75 a6                	jne    80106910 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
8010696a:	c7 04 24 91 78 10 80 	movl   $0x80107891,(%esp)
80106971:	e8 da 9c ff ff       	call   80100650 <cprintf>
  if(newsz >= oldsz)
80106976:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106979:	77 55                	ja     801069d0 <allocuvm+0x100>
8010697b:	90                   	nop
...
801069ce:	5d                   	pop    %ebp
801069cf:	c3                   	ret    
801069d0:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801069d3:	89 fa                	mov    %edi,%edx
801069d5:	8b 45 08             	mov    0x8(%ebp),%eax
801069d8:	e8 93 fa ff ff       	call   80106470 <deallocuvm.part.0>
      return 0;
801069dd:	31 c0                	xor    %eax,%eax
801069df:	eb a1                	jmp    80106982 <allocuvm+0xb2>
801069e1:	eb 0d                	jmp    801069f0 <deallocuvm>
801069e3:	90                   	nop
801069e4:	90                   	nop
801069e5:	90                   	nop
801069e6:	90                   	nop
...
80106a00:	5d                   	pop    %ebp
80106a01:	e9 6a fa ff ff       	jmp    80106470 <deallocuvm.part.0>
...
80106a2a:	e8 41 fa ff ff       	call   80106470 <deallocuvm.part.0>
...
80106a5d:	e8 8e b8 ff ff       	call   801022f0 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
...
80106a72:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106a73:	e9 78 b8 ff ff       	jmp    801022f0 <kfree>
    panic("freevm: no pgdir");
...
80106abb:	e8 c0 d7 ff ff       	call   80104280 <memset>
...
80106ae0:	e8 eb fa ff ff       	call   801065d0 <mappages>
...
80106b4e:	e8 8d f8 ff ff       	call   801063e0 <walkpgdir>
  if(pte == 0)
...
80106b76:	83 ec 2c             	sub    $0x2c,%esp
  ...
  struct proc *curproc = myproc();
80106b79:	e8 22 cb ff ff       	call   801036a0 <myproc>
80106b7e:	89 c3                	mov    %eax,%ebx
80106b80:	89 45 dc             	mov    %eax,-0x24(%ebp)

  if((d = setupkvm()) == 0)
80106b83:	e8 08 ff ff ff       	call   80106a90 <setupkvm>
80106b88:	85 c0                	test   %eax,%eax
80106b8a:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106b8d:	0f 84 81 01 00 00    	je     80106d14 <copyuvm+0x1a4>
    return 0;
  for(i = 0; i < curproc->sz ; i += PGSIZE){
80106b93:	8b 03                	mov    (%ebx),%eax
80106b95:	85 c0                	test   %eax,%eax
80106b97:	0f 84 bb 00 00 00    	je     80106c58 <copyuvm+0xe8>
80106b9d:	31 db                	xor    %ebx,%ebx
80106b9f:	eb 5a                	jmp    80106bfb <copyuvm+0x8b>
...
80106bbd:	e8 5e d7 ff ff       	call   80104320 <memmove>
...
80106be5:	e8 e6 f9 ff ff       	call   801065d0 <mappages>
80106bea:	85 c0                	test   %eax,%eax
80106bec:	78 4f                	js     80106c3d <copyuvm+0xcd>
  for(i = 0; i < curproc->sz ; i += PGSIZE){
80106bee:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106bf1:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106bf7:	39 18                	cmp    %ebx,(%eax)
80106bf9:	76 5d                	jbe    80106c58 <copyuvm+0xe8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106bfb:	8b 45 08             	mov    0x8(%ebp),%eax
80106bfe:	31 c9                	xor    %ecx,%ecx
80106c00:	89 da                	mov    %ebx,%edx
80106c02:	e8 d9 f7 ff ff       	call   801063e0 <walkpgdir>
80106c07:	85 c0                	test   %eax,%eax
80106c09:	0f 84 18 01 00 00    	je     80106d27 <copyuvm+0x1b7>
    if(!(*pte & PTE_P))
80106c0f:	8b 30                	mov    (%eax),%esi
80106c11:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106c17:	0f 84 fe 00 00 00    	je     80106d1b <copyuvm+0x1ab>
    pa = PTE_ADDR(*pte);
80106c1d:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106c1f:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106c25:	89 75 e4             	mov    %esi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106c28:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106c2e:	e8 6d b8 ff ff       	call   801024a0 <kalloc>
80106c33:	85 c0                	test   %eax,%eax
80106c35:	89 c6                	mov    %eax,%esi
80106c37:	0f 85 6b ff ff ff    	jne    80106ba8 <copyuvm+0x38>
            goto bad;
    }
  return d;
...
bad:
  freevm(d);
80106c3d:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106c40:	89 04 24             	mov    %eax,(%esp)
80106c43:	e8 c8 fd ff ff       	call   80106a10 <freevm>
  return 0;
80106c48:	31 c0                	xor    %eax,%eax
}
80106c4a:	83 c4 2c             	add    $0x2c,%esp
80106c4d:	5b                   	pop    %ebx
80106c4e:	5e                   	pop    %esi
80106c4f:	5f                   	pop    %edi
80106c50:	5d                   	pop    %ebp
...
80106c58:	e8 43 ca ff ff       	call   801036a0 <myproc>
80106c5d:	bb fe 0f 00 80       	mov    $0x80000ffe,%ebx
80106c62:	8b 40 7c             	mov    0x7c(%eax),%eax
80106c65:	c1 e0 0c             	shl    $0xc,%eax
80106c68:	29 c3                	sub    %eax,%ebx
80106c6a:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80106c70:	79 58                	jns    80106cca <copyuvm+0x15a>
80106c72:	e9 92 00 00 00       	jmp    80106d09 <copyuvm+0x199>
80106c77:	90                   	nop
        memmove(mem, (char*)P2V(pa), PGSIZE);
...
80106c8d:	e8 8e d6 ff ff       	call   80104320 <memmove>
        if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
...
80106cb5:	e8 16 f9 ff ff       	call   801065d0 <mappages>
80106cba:	85 c0                	test   %eax,%eax
80106cbc:	0f 88 7b ff ff ff    	js     80106c3d <copyuvm+0xcd>
    for(i = PGROUNDUP(KERNBASE - 1 - myproc()->stackNum * PGSIZE); i < KERNBASE ; i += PGSIZE){ // basically  go through userstack
80106cc2:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106cc8:	78 3f                	js     80106d09 <copyuvm+0x199>
        if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106cca:	8b 45 08             	mov    0x8(%ebp),%eax
80106ccd:	31 c9                	xor    %ecx,%ecx
80106ccf:	89 da                	mov    %ebx,%edx
80106cd1:	e8 0a f7 ff ff       	call   801063e0 <walkpgdir>
80106cd6:	85 c0                	test   %eax,%eax
80106cd8:	74 4d                	je     80106d27 <copyuvm+0x1b7>
        if(!(*pte & PTE_P))
80106cda:	8b 30                	mov    (%eax),%esi
80106cdc:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106ce2:	74 37                	je     80106d1b <copyuvm+0x1ab>
        pa = PTE_ADDR(*pte);
80106ce4:	89 f7                	mov    %esi,%edi
        flags = PTE_FLAGS(*pte);
80106ce6:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106cec:	89 75 e4             	mov    %esi,-0x1c(%ebp)
        pa = PTE_ADDR(*pte);
80106cef:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
        if((mem = kalloc()) == 0)
80106cf5:	e8 a6 b7 ff ff       	call   801024a0 <kalloc>
80106cfa:	85 c0                	test   %eax,%eax
80106cfc:	89 c6                	mov    %eax,%esi
80106cfe:	0f 85 74 ff ff ff    	jne    80106c78 <copyuvm+0x108>
80106d04:	e9 34 ff ff ff       	jmp    80106c3d <copyuvm+0xcd>
...
80106d16:	e9 2f ff ff ff       	jmp    80106c4a <copyuvm+0xda>
      panic("copyuvm: page not present");
80106d1b:	c7 04 24 fa 78 10 80 	movl   $0x801078fa,(%esp)
80106d22:	e8 39 96 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106d27:	c7 04 24 e0 78 10 80 	movl   $0x801078e0,(%esp)
...
80106e16:	c7 44 24 04 38 79 10 	movl   $0x80107938,0x4(%esp)
80106e1d:	80 
